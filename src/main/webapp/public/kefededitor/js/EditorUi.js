...
EditorUi.prototype.openFile = function()
{
	...
	var temp = new OpenDialog(this).container;
	this.showDialog(temp, (Editor.useLocalStorage) ? 640 : 320,
        (Editor.useLocalStorage) ? 480 : 220, true, true, function() { window.openFile = null; });
};
