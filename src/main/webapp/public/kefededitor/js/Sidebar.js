...
Sidebar.prototype.init = function()
{
	...
	//	';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
/*	this.addImagePalette('clipart', mxResources.get('kefed'), dir + '/kefed/', '.svg',
    ...
    //function(id, title, prefix, postfix, items, titles, tags)
	//this.addImagePalette('kefed', mxResources.get('kefed'), dir + '/kefed/', '.svg',
    //    ['branch', 'constant', 'entity', 'fork', 'measurement', 'parameter', 'process'],
	//	null ,
	//	{'KEfED': 'basic kefed model', 'OBI': 'obi data'});

	this.addKefedPalette(true);
};
...
/**
 * Adds a template for KEfED elements.
 * Specifics for each icon are defined in ../styles/default.xml
 */
Sidebar.prototype.addKefedPalette = function(expand)
{

    var fns1 = [
        this.createVertexTemplateEntry('kefed_branch;html=1;whiteSpace=wrap;',42,46,'','Branch', null, null, 'kefed branch control'),
        this.createVertexTemplateEntry('kefed_fork;html=1;whiteSpace=wrap;',314,17,'','Fork', null, null, 'kefed fork control'),
    ];

    this.addPaletteFunctions('kefed_protocol', mxResources.get('kefed') + " Control Elements", (expand != null) ? expand : true, fns1);


    var fns2 = [
        this.createVertexTemplateEntry('kefed_entity;html=1;whiteSpace=wrap;',120,63,'','Material Entity', null, null, 'kefed entity protocol'),
        this.createVertexTemplateEntry('kefed_process;html=1;whiteSpace=wrap;',120,63,'','Process', null, null, 'kefed process protocol')
    ];

    this.addPaletteFunctions('kefed_protocol', mxResources.get('kefed') + " Protocol Elements", (expand != null) ? expand : true, fns2);

    var fns3 = [
        this.createVertexTemplateEntry('kefed_constant;html=1;whiteSpace=wrap;',25,25,'','Constant', null, null, 'kefed constant variable'),
        this.createVertexTemplateEntry('kefed_parameter;html=1;whiteSpace=wrap;',25,73,'','Parameter', null, null, 'kefed parameter variable'),
        this.createVertexTemplateEntry('kefed_measurement;html=1;whiteSpace=wrap;',67,67,'','Measurement Datum', null, null, 'kefed measurement variable'),
    ];

    this.addPaletteFunctions('kefed_variables', mxResources.get('kefed') + " Variable Elements", (expand != null) ? expand : true, fns3);
