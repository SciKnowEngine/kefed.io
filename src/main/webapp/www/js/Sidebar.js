...
Sidebar.prototype.init = function()
{
	...
	this.addMaterialTransformation(false);
	this.addProcess(false);
	this.addEntity(false);
	this.addVariables(false);
...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	var fns = [
	 	...
	 	this.createVertexTemplateEntry('parameter;whiteSpace=wrap;html=1;', 70, 60, '', 'Parameter', null, null, 'oval ellipse state'),
...
Sidebar.prototype.addMaterialTransformation = function(expand)
{
	var fns = [
	 	
	 ];
	
	this.addPaletteFunctions('materialTransformations', mxResources.get('materialTransformations'), (expand != null) ? expand : true, fns);
};

Sidebar.prototype.addProcess = function(expand)
{
	var fns = [
	 	
	 ];
	
	this.addPaletteFunctions('processes', mxResources.get('processes'), (expand != null) ? expand : true, fns);
};
...
Sidebar.prototype.addVariables = function(expand)
{
	var fns = [
